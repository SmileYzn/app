                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control" id="chave" name="chave" value="<?= $_POST['chave'] ?>" required>
                        </div>
                        <div class="col-md-3">
                            <label class="form-label">Valor</label>
                            <input type="text" class="form-control" id="valor" name="valor" value="<?= $_POST['valor'] ?>" required>
                        </div>
                        <div class="col-md-3">
