                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-2">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <button type="submit" class="btn btn-primary" id="limpar" name="limpar" value="limpar" title="Buscar">
                                    <i class="bi-x-lg"></i>
                                </button>
                                <?php endif; ?>
                            </div>
                    ...
                    <table class="table table-striped table-hover align-middle text-nowrap text-center m-0">
                        ...
                        foreach($_DADOS as $row)
                        {
                            ...
                            <tr>
                                ...
                                <td><a class="btn btn-sm btn-primary" href="configuracoes/permissao/index.php?fk=<?= Extra::enc($row['id']) ?>"><i class="bi-pencil me-1"></i> Editar</a></td>
                            </tr>
                            <?php
                        }
                        ?>
