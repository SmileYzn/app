                ...
                <div class="card-body">
                    <div class="row g-3 mb-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="date" class="form-control" id="nascimento" name="nascimento" value="<?= $_DADOS['nascimento'] ?>">
                        </div>
                        <div class="col-md-3">
                            ...
                            <select class="form-select" id="unidadeFK" name="unidadeFK" required>
                                ...
                                <option value="<?= $row['id'] ?>" <?= $_DADOS['unidadeFK'] == $row['id'] ? 'selected' : '' ?>><?= $row['nome'] ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        <div class="col-md-3">
                            ...
                            <select class="form-select" id="areaFK" name="areaFK" required>
                                ...
                                <option value="<?= $row['id'] ?>" <?= $_DADOS['areaFK'] == $row['id'] ? 'selected' : '' ?>><?= $row['nome'] ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        <div class="col-md-3">
                            ...
                            <select class="form-select" id="situacaoFK" name="situacaoFK" required>
                                ...
                                <option value="<?= $row['id'] ?>" <?= $_DADOS['situacaoFK'] == $row['id'] ? 'selected' : '' ?>><?= $row['nome'] ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        <div class="col-md-3">
                            <label class="form-label">Usuário</label>
                            <input class="form-control" type="text" id="login" name="login" value="<?= $_DADOS['login'] ?>" autocomplete="new-password" required>
                        </div>
                        <div class="col-md-3">
                            <label class="form-label">Senha</label>
                            <input class="form-control" type="password" id="senha[0]" name="senha[0]" value="<?= Extra::dec($_DADOS['senha']) ?>" autocomplete="new-password" required>
                        </div>
                        <div class="col-md-3">
                            <label class="form-label">Repetir Senha</label>
                            <input class="form-control" type="password" id="senha[1]" name="senha[1]" value="<?= Extra::dec($_DADOS['senha']) ?>" autocomplete="new-password" required>
                        </div>
                    </div>
                    <div class="row g-3 mb-3">
                        <div class="col-md-3">
