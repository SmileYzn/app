...
class ImageResize
{
    ...
    public static function createFromString($image_data)
    {
        ...
        {
            throw new Exception('Os dados da imagem está vazio');
        }
    ...
    public function __construct($filename)
    {
        ...
        switch ($this->source_type)
        {
            ...
            case IMAGETYPE_BMP:
            {
                ...
                {
                    throw new Exception('Para imagens BMP o PHP >= 7.2.0 é requerido');
                }
        ...
        {
            throw new Exception('Falha ao ler a imgem');
        }
    ...
    public function save($filename, $image_type = null, $quality = null, $permissions = null, $exact_size = false)
    {
        ...
        switch ($image_type)
        {
            ...
            case IMAGETYPE_WEBP:
            {
                ...
                {
                    throw new Exception('Para o tipo WebP o PHP >= 5.5.0 é requerido');
                }
                if (!empty($exact_size) && is_array($exact_size))
                {
                    $dest_image = imagecreatetruecolor($exact_size[0], $exact_size[1]);
            ...
            case IMAGETYPE_BMP:
            {
                if (version_compare(PHP_VERSION, '7.2.0', '<'))
                {
                    throw new Exception('Para o tipo WebP o PHP >= 7.2.0 é requerido');
                }
